...
import emptyOrders from '../../assets/no-orders.jpg'
  ...
  return (data.length > 0 ? <div>
    ...
    <div className="text-center py-12">
      ...
      <div className="flex flex-col items-center">
        ...
        />
        <h2 className="text-xl font-bold text-main-theme sm:text-2xl">You made no orders yet</h2>
        <p className="mt-4 text-sm text-gray-600 dark:text-main-theme">
          It looks like you haven't made any orders yet. Start ordering and view your orders here!
        </p>
        <Link to={"/products"}
